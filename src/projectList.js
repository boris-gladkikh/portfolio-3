let projects = [
  ...
  {
    type:"freelance",
    title:"Satellite Respond",
    description:"Artist landing page for electronic band Satellite Respond. Used custom SCSS animation for dynamic background, social media links grid section. Placeholder page for full website, under construction now. ",
    frontend:"HTML/CSS/SCSS",
    backend:"Netlify for hosting and contact form management, no backend server",
    img:"/projects/satellite-site.jpg",
    link:"https://satelliterespond.com",
    github:"https://github.com/boris-gladkikh/satellite-respond"
  },
  ...
  {
    type:"personal",
    title:"Flowstate Boards",
    description:"Front end design for an e-commerce application created in React, utilizing redux for state management and cart interaction.  Visually appealing, fully responsive front page, product & detail pages,  and contact pages created with custom CSS and React-Bootstrap. ",
